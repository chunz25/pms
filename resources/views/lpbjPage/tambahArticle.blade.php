    ...
    <main class="main">
        ...
        <section class="about section">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <br>
                <form class="form-horizontal form-label-left" action="draftlpbj" method="post"
                        ...
                        <div class="col-sm-4">
                            ...
                            @if ($getDraft)
                                <img class=" form-control img-thumbnail"
                                    src="uploads/{{ strtolower($title) }}/{{ $getDraft->gambar }}">
                            @else
                    ...
                    <div class="modal-footer">
                        <a href="pengajuan{{ strtolower($title) }}" class="btn btn-secondary mr-2">Kembali</a>
                        @if (!$getDraft)
