...
<head>
    ...
    <title>List Approval LPBJ</title>
    ...
    <header id="header" class="header grey-background d-flex flex-column">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a href="approvelpbj" class="active"><i class="bi bi-file-earmark-check navicon"></i>Approval</a></li>
                    ...
                    <tbody>
                        @foreach ($dataApprove as $da)
                            <tr>
                                ...
                                <td><a href="detailapprovelpbj/{{ $da->hdrid }}" class="btn btn-sm btn-success"><i
